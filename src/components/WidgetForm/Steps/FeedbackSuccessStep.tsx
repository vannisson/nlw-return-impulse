  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="mt-2 text-xl select-none">
        ...
        <button
          ...
          className="px-6 py-2 mt-6 text-sm leading-6 transition-colors border-transparent rounded-md select-none bg-zinc-800 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
        >
